...
import fr.nelfdesign.googlemapsgoogleplaces.models.placeInfos;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleApiClient.OnConnectionFailedListener{
    ...
    private placeInfos mPlace;

    // Widgets
    private AutoCompleteTextView mSearchText;
    private ImageView icGps;
    ...
    private void init() {
        ...
        icGps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //on lance la methode qui nous donne la dernière location
                getDeviceLocation();
            }
        });
